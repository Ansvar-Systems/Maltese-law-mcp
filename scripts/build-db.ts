#!/usr/bin/env tsx
/**
 * Database builder for Maltese Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Maltese Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Maltese statute text',
              );
